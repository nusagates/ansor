...
<template>
  ...
  <Container>
    <template #content>
      <v-sheet>
        <div>
          <v-sheet height="180" color="teal" @click="randomize">
          ...
          <v-card class="rounded-t-xl" density="compact">
            <v-card-item prepend-icon="mdi-calendar-clock" title="JADWAL IMSAKIYAH">
              <template #subtitle>
                <h3 class="text-uppercase font-weight-bold">Kecamatan Argomulyo & Sekitarnya</h3>
      ...
      <v-dialog width="350" transition="dialog-bottom-transition" v-model="dialog.info">
        <v-card>
          <v-toolbar density="compact">
            ...
            <v-spacer/>
            <v-toolbar-items>
              <v-btn @click="dialog.info=false" variant="text" icon>
          ...
          <v-card-text class="ml-2">
            <ul>
              ...
              <li class="mt-2">Jika ada kritik/saran/masukan silahkan hubungi pengembang melalui
                <v-btn target="_blank" color="teal" href="https://wa.me/6282225005825" variant="text" prepend-icon="mdi-whatsapp">0822 2500 5825</v-btn>
              </li>
            </ul>
          </v-card-text>
        </v-card>
